...
These elements are described in different folders. All the modelling happens within the `openfisca_jersey` folder.
...
```sh
git clone https://github.com/openfisca/openfisca-jersey.git
cd openfisca-jersey
